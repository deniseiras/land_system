subroutine b2o_convert_fscat(handle, status)
...
if (lhook) call dr_hook('b2o_convert_fscat',0,zhook_handle)
...
if (lhook) call dr_hook('b2o_convert_fscat',1,zhook_handle)
...
end subroutine b2o_convert_fscat
