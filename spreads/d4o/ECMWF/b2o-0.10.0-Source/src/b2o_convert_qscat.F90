subroutine b2o_convert_qscat(handle, status)
...
if (lhook) call dr_hook('b2o_convert_qscat',0,zhook_handle)
...
subset_loop: do while (b2o_next_subset(handle))
  ...
  sat(iobs,sat_satellite_instrument) = 313  ! SeaWinds (002019)
...
if (lhook) call dr_hook('b2o_convert_qscat',1,zhook_handle)
...
end subroutine b2o_convert_qscat
