/* Calculates 32-bit, and 64-bit Cyclic Redundancy Check. */
/* The 32-bit variant is equivalen to Unix cksum. */
...
void
b2o_crc32_(const void *vbuf, const int *pnbuf,
...
void
b2o_crc64_(const void *vbuf, const long long int *pnbuf,
