...
class Project(object):
    ...
    def updateProfile(self, aProfile, onlySurfaceParameters=False,
        ...
        if onlySurfaceParameters:
            ...
            print(self.myProfile.profileParamList)
            for sparam in self.myProfile.profileParamList:
    ...
    def ctrlCoherence(self):
        ...
        if debug:
            print("DDDD ctrlGasInProfAndCoefVsOption ")
        self.ctrlGasInProfAndCoefVsOption()
        if debug:
            print("DDDD ctrlOptionsPC")
        self.ctrlOptionsPC()

        # Aerosols control
        if debug:
            print("DDDD ctrl aerosols")
        if self.hasAerosols():
        ...
        if debug:
            print("DDDD  disable gas if required")
