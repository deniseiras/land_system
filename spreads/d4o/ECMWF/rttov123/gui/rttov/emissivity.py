...
if __name__ == '__main__':
    ...
    ofile = os.environ["RTTOV_GUI_PREFIX"] + "/rttov_tests/emis_profile.H5"
    ...
    ofile = os.environ["RTTOV_GUI_PREFIX"] + "/rttov_tests/emis_surface.H5"
    of = h5py.File(ofile, 'w')
    ...
    myfile = os.environ["RTTOV_GUI_PREFIX"] + "/rttov_tests/emis_surface.H5"
