...
class Option(OrderedDict, _V):
    ...
    def __init__(self):
        ...
        self["USER_CLD_OPT_PARAM"] = OptionObject(
            ...
            theme=1,
            hidden=True)
        self["CLDSTR_THRESHOLD"] = OptionObject(
            value=-1,
            otype=float,
            min_max_values=(-1, 1),
            comment="Ignore cloud streams with "
        ...
        self["IR_SCATT_MODEL"] = OptionObject(
            ...
            odict=self.dictOptions[
                "IR_SCATT_MODEL"],
            comment="IR scattering model to use"
        ...
        self["VIS_SCATT_MODEL"] = OptionObject(
            ...
            odict=self.dictOptions[
                "ALL_VIS_SCATT_MODEL"],
            comment="VIS/NIR scattering model to use"
        ...
        self["CLDSTR_SIMPLE"] = OptionObject(theme=1, hidden=True)
        self["CLDSTR_LOW_CLOUD_TOP"] = OptionObject(
            value=750,
            otype=float,
        ...
        self["GRID_BOX_AVG_CLOUD"] = OptionObject(
            theme=1,
            comment="simulations supplied as model-box overages")
        self["RAYLEIGH_SINGLE_SCATT"] = OptionObject(theme=1)
        ...
        self["APPLY_BAND_CORRECTION"] = OptionObject(
            theme=4,
            comment="Apply band-correction for Planck radiance "
            "and BT calculations"
        )
        ...
        self["CLW_SCHEME"] = OptionObject(
            ...
            comment="CLW scheme",
            hidden=True)
        theComment = "Switch to compute CLW absorption on coef/user levels"
        self["CLW_CALC_ON_COEF_LEV"] = OptionObject(theme=4,
                                                    comment=theComment,
                                                    hidden=True)
...
if __name__ == '__main__':
    ...
    # Open file ReadOnly
    fileName = '../rttov_tests/profile.h5'
