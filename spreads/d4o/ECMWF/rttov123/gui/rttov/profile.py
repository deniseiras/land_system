...
class Profile(dict):
    ...
    typeListe = {"IDG": {1: "Ou and Liou", 2: "Wyser", 3: "Boudala",
                         4: "McFarquhar"},
                 "ICE_SCHEME": {1: "SSEC ice dataset", 2: "Baran 2014"},
    ...
    def setDefaultAttributes(self):
        ...
        self["ICE_SCHEME_ATTRIBUTE"] = {
            'COMMENT': (
                'Choose the ice scheme, 1=SSEC ice database;2=Baran 2014'),
            'UNITS': 'n/a'}
        ...
        self["SKIN"]["FOAM_FRACTION_ATTRIBUTE"] = {
            ...
            'UNITS': '0:1'}
        self["SKIN"]["SPECULARITY_ATTRIBUTE"] = {
            'COMMENT': ('specifies linear combination of Lambertian'
                        ' and specular downwelling radiance'),
            'UNITS': '0 (purely Lambertian) to 1 (purely specular)'}
        ...
        self["ICE_SCHEME_ATTRIBUTE"] = {
            'COMMENT': 'ice cloud scheme (1-2)', 'UNITS': 'n/a'}
        self["CLW_SCHEME_ATTRIBUTE"] = {
            'COMMENT': 'liquid cloud scheme (1-2)', 'UNITS': 'n/a'}
    ...
    def setDefaultProfileAsciiInput(self):
        ...
        if self["IDG"] is None:
            self["IDG"] = 1   # Ice effective diameter parameterisation
        if self["ICE_SCHEME"] is None:
            self["ICE_SCHEME"] = 2  # Ice cloud scheme (Baran is default)
        ...
        if self["SKIN"]["SPECULARITY"] is None:
            self["SKIN"]["SPECULARITY"] = 0.0
