...
from .util import kindOfItem
from . import profileframeutils as pfu
import logging
from . import colors
...
class KProfileView (util.GenericViewRadio):
    ...
    def __init__(self, parent, channel=1,
        ...
        self.SetTitle("run K profile channel %d" % (channel))
    ...
    def OnQuit(self, e):
        logging.debug("OnClose must unsubscribe")
        pub.unsubscribe(self.OnKMatChanged, "K-Matrix Changed")
        self.Destroy()
...
if __name__ == "__main__":
    ...
    checkCode(err)
    frame = KProfileView(None, channel=18,
