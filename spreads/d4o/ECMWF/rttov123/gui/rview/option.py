...
class OptionView(util.GenericView):
    ...
    def __init__(self, parent, project, controller=None):
        ...
        self.numberParamDict = {"CLDSTR_THRESHOLD": {"step": 0.001,
                                                     "format": "%f",
                                                     "ndigits": 3},
        ...
        for i in range(6):
            ...
            if i == 0:
                ...
                self.gb.Add(self.boxsizers[self.optionsThemes[i]],
                            pos=(i - 3, 2), border=20, flag=wx.EXPAND)
    ...
    def GetValuesItems(self):
        ...
        try:
            for parameter in ['CLDSTR_THRESHOLD',
                              "DOM_OPDEP_THRESHOLD",
                              "DOM_ACCURACY"]:
