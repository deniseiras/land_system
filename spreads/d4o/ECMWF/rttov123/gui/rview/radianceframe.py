...
"""
# 2013-05-29 : test combobox
# 2013-06-12 : routines redraw
# 2013-10-30 : SetSiserAndFit() en SetSiser()
# 2014-01-28 : pseudo-run = run_xx - run_01 (base run)
# 2014-01-29 : bug sur echelle Y lors des zooms : ok sans set_yticklabels()
# 2014-01-29 : version sans subplots Refl pour micro ondes
# 2014-02-06 : version init et read_h5 avec param supplementaire = addsolar
# 2014-02-11 : delete+insert page notebook (addsolar)
# 2014-02-12 : titres pseudo_runs = TOTAL_( run_0x - run_01 )
# 2014-02-12 : titres pseudo_chns : TOTAL_( formula_0x )
# 2014-02-13 : choix run reference (pages 111 et run liees)
# 2014-02-13 : affichage X/Y des pseudo run
# 2014-02-14 : pas d'afficahe si tous points NaN
# 2014-02-14 : ecriture StatusBar avec dateheure (sauf afficahge X/Y)
# 2014-02-19 : double courbe (twinx) pour diff_run sur OnePlot
# 2014-02-19 : pas de marker si chn>50
# 2014-02-26 : adaptations pour PCCOMP
# 2014-05-07 : writeSB et refreshSB dans rview/util.py
# 2014-05-14 : cas instrument monocanal
# 2015-07-30 : OnPlot displayed by default
# 2015-09-03 : BT displayed by default
# 2015-09-09 : si chn>50 X en wv (fonction : find_nearest)
# 2015-09-10 : pseudo run : minus and versus
# 2016-09-07 : corr xlabel (runs/channels) + refrun/byCha + int(x)
#
"""
