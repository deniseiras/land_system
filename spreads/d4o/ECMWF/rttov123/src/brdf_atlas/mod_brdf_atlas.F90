...
!------------------------------------------
  ...
  !> Main subroutine to return BRDFs and, optionally, bi-hemipsherical albedos
  ...
  !! @param[out]      instr_bh_albedo     calculated bi-hemipsherical albedo values, optional
...
!       instr_brdf = MIN(instr_brdf, 1._jprb)
  ...
  !> Compute BRDF and bi-hemipsherical albedo from the semi-empirical model of
  ...
  !! @param[out]     modisalbedo     calculated bi-hemipsherical albedo
