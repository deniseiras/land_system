...
sname='IDG'
call write_array_hdf(lun,sname,'IDG',err,i0=x(1)%IDG )
THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
...
sname='SPECULARITY'
call write_array_hdf(lun,sname,'Mix of specular/Lambertian for do_lambertian option (0-1, 0=Lambertian/1=specular)',&
        err,r0=x(1)%skin%SPECULARITY,units='0:1')
THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
