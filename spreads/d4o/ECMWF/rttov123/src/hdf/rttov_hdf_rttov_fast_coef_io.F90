...
if(associated(x%MIXEDGAS))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%MIXEDGAS , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
...
if(associated(x%WATERVAPOUR))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%WATERVAPOUR , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
  THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
endif
...
if(associated(x%OZONE))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%OZONE , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
  THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
endif
...
if(associated(x%WVCONT))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%WVCONT , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
  THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
endif
...
if(associated(x%CO2))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%CO2 , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
  THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
endif
...
if(associated(x%N2O))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%N2O , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
  THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
endif
...
if(associated(x%CO))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%CO , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
  THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
endif
...
if(associated(x%CH4))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%CH4 , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
  THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
endif
...
if(associated(x%SO2))then
  call write_array_hdf(lun,sname,&
    ...
    & err,r3=x%SO2 , units = 'n/a' ,compress=compress,compdims=(/-1,-1,1/) ,force_double=force_double)
  THROWM(err.ne.0,"CANNOT WRITE "//trim(sname))
endif
