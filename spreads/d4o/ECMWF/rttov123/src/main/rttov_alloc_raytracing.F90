...
!- End of header --------------------------------------------------------
  ...
  IF (asw == 1) THEN
    ALLOCATE (                                                                                  &
        ...
        raytracings%pathsat(nlayers, nprofiles), raytracings%pathsat_rsqrt(nlayers, nprofiles), &
        raytracings%pathsat_sqrt(nlayers, nprofiles), raytracings%ltick(nlayers, nprofiles),    &
        raytracings%co2_cm(nprofiles), STAT = err)
    ...
    IF (addsolar) THEN
      ALLOCATE (                                    &
          ...
          raytracings%patheff(nlayers, nprofiles), STAT = err)
