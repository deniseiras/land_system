...
!
    emissfactor_v   = pol_v(1, pol_id) + pol_v(2, pol_id) * geom%sinview_sq + pol_v(3, pol_id) * geom%cosview_sq
    emissfactor_h   = pol_h(1, pol_id) + pol_h(2, pol_id) * geom%sinview_sq + pol_h(3, pol_id) * geom%cosview_sq
    emissivity(i)   =                                                                                                    &
      & emissstokes(i, 1) * emissfactor_v + emissstokes(i, 2) * emissfactor_h + emissstokes(i, 3) * pol_s3(0, pol_id) +  &
      & emissstokes(i, 4) * pol_s3(1, pol_id)
    reflectivity(i) =                                                                                                       &
      & reflectstokes(i, 1) * emissfactor_v + reflectstokes(i, 2) * emissfactor_h + reflectstokes(i, 3) * pol_s3(0, pol_id) &
      &  + reflectstokes(i, 4) * pol_s3(1, pol_id)
