...
!
    emissfactor_v_k       = pol_v(1, pol_id) + pol_v(2, pol_id) * geom%sinview_sq + pol_v(3, pol_id) * geom%cosview_sq
    emissfactor_h_k       = pol_h(1, pol_id) + pol_h(2, pol_id) * geom%sinview_sq + pol_h(3, pol_id) * geom%cosview_sq
