...
!   REAL(jprb)            :: small_val = (tiny(min_exponent)) ** (0.333333_jprb) ! XLF doesn't like 1/3
  ...
  ! Platform ID codes
  INTEGER(KIND=jpim), PARAMETER :: nplatforms = 59
  ...
  INTEGER(KIND=jpim), PARAMETER :: &
         ...
         platform_id_forum     = 58, platform_id_tempestd  = 59
  ...
  CHARACTER(LEN=9), PARAMETER :: platform_name(nplatforms) = &
         (/ 'noaa     ', 'dmsp     ', 'meteosat ', 'goes     ', 'gms      ', &
            ...
            'cloudsat ', 'cloudcore', 'forum    ', 'tempestd ' /)
  ...
  INTEGER(KIND=jpim), PARAMETER :: ninst = 112
...
!          mno2, mhno3, mocs, mn2, mccl4, mcfc11, mcfc12, mcfc14 /)
  ...
  ! ----------------------------------------
  ! Temperature
  REAL(KIND=jprb), PARAMETER :: tmax   = 1700_jprb !400.0_jprb       ! degK
  REAL(KIND=jprb), PARAMETER :: tmin   = 20_jprb  !90.0_jprb        ! degK
  ! Water Vapour
...
!   REAL(KIND=jprb), PARAMETER :: ccthres = 0.05_jprb
  ...
  ! Ice clouds
  INTEGER(KIND=jpim), PARAMETER :: nice_scheme = 3 ! Max valid value for ice_scheme
  INTEGER(KIND=jpim), PARAMETER :: ice_scheme_ssec      = 1
  INTEGER(KIND=jpim), PARAMETER :: ice_scheme_baran     = 2
  INTEGER(KIND=jpim), PARAMETER :: ice_scheme_baran2018 = 3
  ...
  REAL(KIND=jprb), PARAMETER :: cfrac_min = 1.E-6_jprb
