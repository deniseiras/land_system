...
!!   applying the optical depth regression.
!!
!> @brief
!!   Calculates level-to-space optical profiles for each channel by
!!   applying the optical depth regression.
...
!! @param[in]     thermal         flag to indicate thermal (rather than solar) optical depths are
!!                                  being calculated
!
! Copyright:
...
!INTF_END
  ...
  INTEGER(KIND=jpim)       :: lev, lay, chan, j, prof, nlevels, nchanprof, ind
