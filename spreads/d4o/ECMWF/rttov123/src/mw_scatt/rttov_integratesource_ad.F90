...
!* Coefficients
     aa  = scatt_aux % b0 (ichan,ii) - 1.5_JPRB * scatt_aux % asm (ichan,ii) * scatt_aux % ssa (ichan,ii) &
...
!* Downward radiance source terms    
     ...
     scatt_aux_ad % b0  (ichan,ii) = scatt_aux_ad % b0  (ichan,ii) + aa_ad 
