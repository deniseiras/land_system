...
integer (kind=jpim) :: i_lev, i_proma, i_chan, i_btout, i_lambda, i_fast, i_output, ioout
...
call rttov_alloc_scatt_prof ( err, kproma, cld_profiles, kflevg, use_totalice, asw, &
  init = .true._jplm)
