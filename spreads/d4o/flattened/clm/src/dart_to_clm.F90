...
!LGG
     print *, 'LGG calling update_snowB'
     call update_snowB(dom_restart, ncid_dart, ncid_clm, ICE_varsize(2), &
                      ICE_varsize(1), nlevsno, repartition_swe)
     
     print *, 'LGG before update_snow',dom_restart, ncid_dart, ncid_clm, ICE_varsize(2), &
                      ICE_varsize(1), nlevsno, repartition_swe     
...
subroutine update_snowB(dom_id, ncid_dart, ncid_clm, ncolumn, nlevel, nlevsno, repartition_swe)

integer, intent(in) :: dom_id
integer, intent(in) :: ncid_dart
integer, intent(in) :: ncid_clm
integer             :: ncid_clm_vector, ncid_dart_vector
character(len=*), parameter :: routine = 'update_snowB'
...
print *, 'LGG inside update_snowB'

end subroutine update_snowB
...
!LGG
print *, 'LGG before test'
print *, 'LGG ',nc_variable_exists(ncid_clm, 'SNLSNO')
