...
use        location_mod, only : location_type, get_location, &
                                ...
                                has_vertical_choice, query_location, qloc_which_vert
...
if (write_vert) then
   ...
   intval = query_location(location) ! qloc_which_vert (the default)
...
do i=1, loccount
   ...
   if (write_vert) intvals(i) = query_location(locations(i)) ! qloc_which_vert (the default)
enddo
