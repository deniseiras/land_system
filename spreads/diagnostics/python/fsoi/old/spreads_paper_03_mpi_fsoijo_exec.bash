...
#BSUB -P R000
#BSUB -x 
#BSUB -J spreads_paper_03_mpi_fsoi 
#BSUB -o spreads_paper_03_mpi_fsoi.out
#BSUB -e spreads_paper_03_mpi_fsoi.err
##BSUB -I
...
echo " "
rm -f spreads_paper_03_mpi_fsoi.out spreads_paper_03_mpi_fsoi.err spreads_paper_03_mpi_fsoi.log*
...
/usr/bin/time -v ${LAUNCHCMD} python3 ./spreads_paper_03_mpi_fsoijo_en.py  > spreads_paper_03_mpi_fsoi.log.$LSB_JOBID 2>&1 || rc=$?
