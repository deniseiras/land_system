...
#obsdir=/work/cmcc/gc02720/observations/AMSUL1B_20170114-25
obsdir=/work/cmcc/gc02720/observations/amsua-test/allswaths21600
#obsdir=/work/cmcc/gc02720/observations/amsua-test/high
...
#echo $greg1 $secs1
  ...
  case  ${mhour} in
    "00")
      #echo "mhour is ${mhour}"
      ls ${obsdir}/obs_seq.amsua.${cyear}.${cmonth}.${cday}* | awk -F'[.]' '($6>=210 && $6<=240){print $0}' >> olist      
      ls ${obsdir}/obs_seq.amsua.${nyear}.${nmonth}.${nday}* | awk -F'[.]' '($6>=0 && $6<=30){print $0}' >> olist      
    ;;
    "06")
      #echo "mhour is ${mhour}"
      ls ${obsdir}/obs_seq.amsua.${cyear}.${cmonth}.${cday}* | awk -F'[.]' '($6>=30 && $6<=90){print $0}' >> olist      
    ;;
    "12")
      #echo "mhour is ${mhour}"
      ls ${obsdir}/obs_seq.amsua.${cyear}.${cmonth}.${cday}* | awk -F'[.]' '($6>=90 && $6<=150){print $0}' >> olist      
    ;;
    "18")
      #echo "mhour is ${mhour}"
      ls ${obsdir}/obs_seq.amsua.${cyear}.${cmonth}.${cday}* | awk -F'[.]' '($6>=150 && $6<=210){print $0}' >> olist      
    ;;
  esac
...
#  cat olist
  ...
  sed -e "s#YYYY#${myear}#g"    \
      ...
      -e "s#GREGN#${greg1}#g"   \
      -e "s#SECS0#${secs0}#g"   \
      -e "s#SECSN#${secs1}#g"   < ./input.nml.amsua.template > input.nml
  ...
  ../work/obs_sequence_tool
   ...
   case  ${mhour} in
    "00")
      mv ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.${mhour} ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.00000 
    ;;
    "06")
      mv ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.${mhour} ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.21600 
    ;;
    "12")
      mv ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.${mhour} ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.43200 
    ;;
    "18")
      mv ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.${mhour} ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.64800 
    ;;
  esac 
