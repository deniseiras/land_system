...
#     adapted for AMSU-A.  This script needs 
...
convdir=/work/cmcc/gc02720/observations/CONV_201701_6H_CESM
raddir=/work/cmcc/gc02720/observations/amsua-test/allswaths21600/201701_6H
#raddir=/work/cmcc/gc02720/observations/CH08-09_201701_6H_CESM
OUTDIR=/work/cmcc/gc02720/observations/final_CHALL_CONV_201701_6H_CESM
...
end_d=(`echo ${end_year}${mon2}${day2}03 0 -g | ../work/advance_time`)
echo $end_d

mon2=`printf %02d $start_month`
day2=`printf %02d $start_day`
start_d=(`echo ${start_year}${mon2}${day2}03 0 -g | ../work/advance_time`)
echo $start_d

# these are a string in the format YYYYMMDDHH
# do them here to prime the loop below which first takes them apart.
currtime=(`echo ${start_year}${mon2}${day2}03  0  | ../work/advance_time`)
nexttime=(`echo ${start_year}${mon2}${day2}03 +6h | ../work/advance_time`)
middtime=(`echo ${start_year}${mon2}${day2}03 +3h | ../work/advance_time`)
...
#echo midd $myear $mmonth $mday $mhour
  ...
  g=(`echo ${cyear}${cmonth}${cday}${chour} +1s -g | ../work/advance_time`)
  greg0=${g[0]}
  let secs0=${g[1]}
  g=(`echo ${cyear}${cmonth}${cday}${chour} +6h -g | ../work/advance_time`)
  greg1=${g[0]}
  let secs1=${g[1]}
#echo $greg0 $secs0
#echo $greg1 $secs1
  ...
  #OUTDIR=${obsdir}/${myear}${mmonth}_6H
  if [[ ! -d ${OUTDIR} ]] ; then
       mkdir ${OUTDIR}
  fi
  ...
  case  ${mhour} in
    "00")
      #echo "mhour is ${mhour}"
      echo ${raddir}/obs_seq.amsua.${myear}.${mmonth}.${mday}.00000  >> olist      
      echo ${convdir}/obs_seq.${myear}-${mmonth}-${mday}-00000  >> olist      
    ;;
    "06")
      #echo "mhour is ${mhour}"
      echo ${raddir}/obs_seq.amsua.${myear}.${mmonth}.${mday}.21600  >> olist      
      echo ${convdir}/obs_seq.${myear}-${mmonth}-${mday}-21600  >> olist      
    ;;
    "12")
      #echo "mhour is ${mhour}"
      echo ${raddir}/obs_seq.amsua.${myear}.${mmonth}.${mday}.43200  >> olist      
      echo ${convdir}/obs_seq.${myear}-${mmonth}-${mday}-43200  >> olist      
    ;;
    "18")
      #echo "mhour is ${mhour}"
      echo ${raddir}/obs_seq.amsua.${myear}.${mmonth}.${mday}.64800  >> olist      
      echo ${convdir}/obs_seq.${myear}-${mmonth}-${mday}-64800  >> olist      
    ;;
  esac
...
#  cat olist
  ...
  sed -e "s#YYYY#${myear}#g"    \
      ...
      -e "s#GREGN#${greg1}#g"   \
      -e "s#SECS0#${secs0}#g"   \
      -e "s#SECSN#${secs1}#g"   < ./input.nml.merge_conv_rad > input.nml
  ...
  # the program in model has been compiled with all the observations
  /users_home/cmcc/gc02720/DART/models/cam-fv/work/obs_sequence_tool
 
   case  ${mhour} in
    "00")
      mv ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.${mhour} ${OUTDIR}/obs_seq.${myear}-${mmonth}-${mday}-00000 
    ;;
    "06")
      mv ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.${mhour} ${OUTDIR}/obs_seq.${myear}-${mmonth}-${mday}-21600 
    ;;
    "12")
      mv ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.${mhour} ${OUTDIR}/obs_seq.${myear}-${mmonth}-${mday}-43200 
    ;;
    "18")
      mv ${OUTDIR}/obs_seq.amsua.${myear}.${mmonth}.${mday}.${mhour} ${OUTDIR}/obs_seq.${myear}-${mmonth}-${mday}-64800 
    ;;
  esac 
  ...
  middtime=(`echo ${nyear}${nmonth}${nday}${nhour} +3h | ../work/advance_time`)
