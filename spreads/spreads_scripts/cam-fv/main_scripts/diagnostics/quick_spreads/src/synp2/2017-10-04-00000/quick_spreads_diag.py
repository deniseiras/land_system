...
# path2sv = f'/work/cmcc/gc02720/github/spreads/spreads_scripts/cam-fv/main_scripts/diagnostics/quick_spreads'
...
for directory in filtered_directories:
    ...
    listdb.sort()
   #  listdb = listdb[0:3]
   #  listdb = ["/work/cmcc/gc02720/CMCC-CM/archive/spreads_v5/spreads_v5-2017-10-05-43200/spreads_v5.spreads.AMSU.10.2017-10-05-43200.db"]
   #  print(listdb)
   #  quit()
    for db in listdb:
