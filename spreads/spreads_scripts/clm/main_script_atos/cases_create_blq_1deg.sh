...
# Set the obs dir
baseobsdir="/ec/res4/scratch/gc02720/obs/b2d4o_synp_30052024"
...
script_name_original="case.template-atos.original-SP-1deg"
...
ICDIR="/ec/res4/scratch/ita4441/ic_1deg"
