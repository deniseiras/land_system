...
patharc   = "/ec/res4/scratch/mg20022/CMCC-CM/archive"
...
path2sv = f'/ec/res4/scratch/mg20022/CMCC-CM/basic_diag/{ename}/{start_date}'
# path2sv = f'/ec/res4/scratch/mg20022/github/spreads/spreads_scripts/cam-fv/main_scripts/diagnostics/quick_spreads'
...
for directory in filtered_directories:
    ...
    listdb.sort()
   #  listdb = listdb[0:3]
   #  listdb = ["/ec/res4/scratch/mg20022/CMCC-CM/archive/spreads_v5/spreads_v5-2017-10-05-43200/spreads_v5.spreads.AMSU.10.2017-10-05-43200.db"]
   #  print(listdb)
   #  quit()
    for db in listdb:
