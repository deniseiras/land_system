...
export clonesroot="/users_home/cmcc/${USER}/${CESMEXP}/check2"

# Number of clones
nens=5

# DART directory
export dartroot="/users_home/cmcc/${USER}/spreads"

# DA working dir
tmpdir="/work/cmcc/${USER}/CMCC-CM/TMPCHECK2"

# Archive (to remove previous files)
archdir="/work/cmcc/${USER}/CMCC-CM/archive"

# Set the obs dir
baseobsdir="/work/cmcc/gc02720/obs/b2d4o_1deg_test"
...
dartnamelist="input.nml.original.rad-1deg"
...
# IC dir
ICDIR="/work/cmcc/gc02720/ic/ic_spread_ugento_1deg"
...
do
  ...
  # ${MOVE} user_nl_clm_0001 user_nl_clm
   ...
   if [ "${script_name_original}" != "case.template-juno.original-SP-1deg" ] && [ "${script_name_original}" != "case.template-juno.original-SP" ] && [ "${script_name_original}" != "case.template-juno.original-SP-foretest" ]; then
