...
echo "inside ./run_dart_to_clm_snow.bash ${CASEL} ${case_name} ${LND_DATE_EXT} ${CASESRUNROOT} ${nens}"
string_id=""
...
#for RESTART in "${CASE}.clm2_"*.r."${LND_DATE_EXT}".nc; do
    ...
    #CLM_VECTOR="${CASE}.clm2_00$(printf "%02d" $enscount).h2.${LND_DATE_EXT}.nc"
    CLM_VECTOR="$CASESRUNROOT/${case_name}_${ni}/run/${CASEL}_${ni}.clm2.h2.${LND_DATE_EXT}.nc"
