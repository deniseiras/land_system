...
do
   ...
   echo "$ATM_DATE"  
   cp ${case_name}${inst_string}.cam.i.${ATM_DATE}.nc bk_${case_name}${inst_string}.cam.i.nc
   cp ${case_name}${inst_string}.clm2.r.${ATM_DATE}.nc bk_${case_name}${inst_string}.clm2.r.nc
   cp ${case_name}${inst_string}.mosart.r.${ATM_DATE}.nc bk_${case_name}${inst_string}.mosart.r.nc
   cp ${case_name}${inst_string}.cice.r.${ATM_DATE}.nc bk_${case_name}${inst_string}.cice.r.nc
   cp ${case_name}${inst_string}.cpl.r.${ATM_DATE}.nc bk_${case_name}${inst_string}.cpl.r.nc
   cp ${case_name}${inst_string}.docn.rs1.${ATM_DATE}.bin bk_${case_name}${inst_string}.docn.rs1.bin
   cp rpointer.atm bk_rpointer.atm
   cp rpointer.lnd bk_rpointer.lnd
   cp rpointer.rof bk_rpointer.rof
   cp rpointer.ice bk_rpointer.ice
   cp rpointer.ocn bk_rpointer.ocn
   cp rpointer.drv bk_rpointer.drv
