...
if [ ${#PID} -eq 0 ];then
    ...
    /work/cmcc/mg20022/.conda/envs/ecflow/bin/ecflow_server --port=${ECF_PORT} &
    ...
    /work/cmcc/mg20022/.conda/envs/ecflow/bin/ecflow_client --restart
    
else
    echo -e "\nERROR!!! This ECF_PORT have been used on Juno:"
