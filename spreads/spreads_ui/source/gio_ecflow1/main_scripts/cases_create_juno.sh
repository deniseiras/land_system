...
export clonesroot="/users_home/cmcc/${USER}/${CESMEXP}/synp"
...
# DA working dir
tmpdir="/work/cmcc/${USER}/CMCC-CM/TMPSYNP"
...
# Set the obs dir
baseobsdir="/work/cmcc/gc02720/b2d4o_synp"
...
do
  ...
  # ${MOVE} user_nl_clm_0001 user_nl_clm
   ...
   if [ "${script_name_original}" != "case.template-juno.original-SP" ]
     then
