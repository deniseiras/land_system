...
# DA working dir
tmpdir="/work/cmcc/${USER}/CMCC-CM/TMPSYNP2_FPE0"

# Archive (to remove previous files)
archdir="/work/cmcc/${USER}/CMCC-CM/archive"

# Set the obs dir
baseobsdir="/work/cmcc/gc02720/b2d4o_synp2"
...
do
  ...
  # ${MOVE} user_nl_clm_0001 user_nl_clm
   ...
   if [ "${script_name_original}" != "case.template-juno.original-SP" ] && [ "${script_name_original}" != "case.template-juno.original-SP-foretest" ]; then
