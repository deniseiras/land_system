...
#setenv compset        HIST_DATM%GSWP3v1_CLM51%BGC-CROP_SICE_SOCN_HYDROS_SGLC_SWAV_SESP
...
if (${num_instances} == 1) then
   ...
   #setenv CASE control
   setenv CASE d4o_m04_v01_cassandra
endif
...
# TODO
# setenv SourceModDir  /work/cmcc/$USER/land_system_work/land/datain/SourceMods_release-cesm2.3_lgg/SourceMods
# ==============================================================================
# Directories:
...
setenv cesmroot         /work/cmcc/$USER/land_system_work/users_home_cmcc_cp1/CMCC-CM
#setenv cesmroot         /users_home/cmcc/dp16116/CMCC-CM_v9
#setenv cesmroot         /work/cmcc/lg07622/land/cesm_dart
setenv caseroot         /work/cmcc/$USER/land_system_work/work_d4o/${CASE}
setenv cime_output_root /work/cmcc/$USER/land_system_work/work_d4o/${CASE}
...
setenv dartroot               /work/cmcc/$USER/land_system_work/work_dart/DART
setenv baseobsdir             /work/cmcc/$USER/land_system_work/land/datain/observations/ESA_CCI_SM/obs/all
...
setenv stagedir /work/cmcc/$USER/land_system_work/work_d4o/${refcase}/run
