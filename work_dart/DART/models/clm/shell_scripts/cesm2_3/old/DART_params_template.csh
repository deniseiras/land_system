...
if (${num_instances} == 1) then
   setenv CASE lnd_multi
else
   setenv CASE lnd_temp2
endif
...
setenv cime_output_root /work/cmcc/lg07622/CMCC-CM
#setenv rundir           ${cime_output_root}/${CASE}/run
#setenv exeroot          ${cime_output_root}/${CASE}/bld
setenv archdir          ${cime_output_root}/archive/${CASE}
