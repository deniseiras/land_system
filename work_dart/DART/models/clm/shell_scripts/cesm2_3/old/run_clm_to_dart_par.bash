...
#BSUB -n 2                    # Número de núcleos de CPU solicitados (2 núcleos)
#BSUB -q p_short              # Fila de jobs curta
#BSUB -R "rusage[mem=12GB]"   # Requisita 2000 MB de memória por job
#BSUB -R "span[ptile=8]"      # Máximo de 8 processos por nó
