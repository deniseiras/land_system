...
if (${num_instances} == 1) then
   setenv CASE clm5_ctr
else
   setenv CASE clm5_forc
endif
...
setenv caseroot         /work/cmcc/lg07622/land/work/clm5/${CASE}
setenv cime_output_root /work/cmcc/lg07622/land/work/clm5/${CASE}
...
#setenv baseobsdir             /work/cmcc/lg07622/land/datain/GLASS_LAI/obs/8day/2011
setenv baseobsdir             /work/cmcc/lg07622/land/datain/ESA_CCI_SM/obs/2011
...
#setenv refcase      clm5_test2
setenv refcase      cm3_lndHIST_t01b
setenv refyear      2015
setenv refmon       01
setenv refday       01
setenv reftod       00000
...
#setenv stagedir /work/cmcc/lg07622/land/refcase/multi
...
#setenv stagedir /work/cmcc/lg07622/land/datain/refcase/2015/test2
